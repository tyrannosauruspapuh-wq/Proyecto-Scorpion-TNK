// Versión 1.2.1 del módulo top para la Tang Nano 9K
            ...
            if (bit_idx < 4'd8) begin
                ...
                if (state_mode == 2'd1) begin
                    ...
                    case (data_raw)
                        ...
                        8'h03: motors <= 4'b0110; // Izquierda (L) -> CORREGIDO
                        8'h04: motors <= 4'b1001; // Derecha (R)   -> CORREGIDO
